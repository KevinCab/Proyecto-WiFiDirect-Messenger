...
public class MainActivity extends ActionBarActivity implements
    ...
    private void forcedCancelConnect() {
        manager.cancelConnect(channel, new ActionListener() {
            ...
            public void onSuccess() {
                ...
                Toast.makeText(MainActivity.this, "Conexión Cancelada", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(int reason) {
                Log.d(TAG, "forcedCancelConnect failed, reason: " + reason);
                Toast.makeText(MainActivity.this, "No se pudo Cancelar", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void internalStopDiscovery() {
        manager.stopPeerDiscovery(channel,
                new CustomizableActionListener(
                        ...
                        "Búsqueda Detenida",
                        "Búsqueda Detenida",
                        "No se puede detener la busqueda",
                        "No se puede detener la busqueda"));
        ...
        manager.clearLocalServices(channel,
                new CustomizableActionListener(
                        MainActivity.this,
                        "internalStopDiscovery",
                        "Limpieza de servicios locales exitosa",
                        null,
                        "Limpieza de servicios locales fallida",
                        null));
    }
    ...
    private void discoverService() {
        ...
        manager.discoverServices(channel, new ActionListener() {
            ...
            @Override
            public void onSuccess() {
                Log.d(TAG, "Se inicio la búsqueda");
                Toast.makeText(MainActivity.this, "Se inicio la búsqueda", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(int reason) {
                ...
                Toast.makeText(MainActivity.this, "Error del servicio de búsqueda, " + reason, Toast.LENGTH_SHORT).show();
    ...
    private void disconnectBecauseOnStop() {
        ...
        if (manager != null && channel != null) {
            ...
            Log.d("disconnectBecauseOnStop", "Imposible Desconectar");
        }
    }
        ...
        if (manager != null && channel != null) {
            ...
            manager.removeGroup(channel, new ActionListener() {
                ...
                public void onFailure(int reasonCode) {
                    Log.d(TAG, "Error de desconexion. Razon :" + reasonCode);
                    Toast.makeText(MainActivity.this, "Error de desconexion", Toast.LENGTH_SHORT).show();
                }
            ...
            case Configuration.MESSAGE_READ:
                ...
                if (tabFragment.isValidTabNum(tabNum)) {
                    ...
                    if (Configuration.DEBUG_VERSION) {
                        ...
                        tabFragment.getChatFragmentByTab(tabNum).pushMessage("Amigo: " + readMessage);
                    } else {
                        if (!readMessage.contains(Configuration.MAGICADDRESSKEYWORD)) {
                            tabFragment.getChatFragmentByTab(tabNum).pushMessage("Amigo: " + readMessage);
                        }
